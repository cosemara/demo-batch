...
@Getter
@Entity
@Table(name = "assets_tx_stat")
@NoArgsConstructor
@ToString
public class AssetsTxStat extends BaseEntity {
    @Id
    ...
    @Builder
    public AssetsTxStat(Long id, AssetsType assetsType, User user, AssetsTxType assetsTxType, Integer amount) {
        this.id = id;
